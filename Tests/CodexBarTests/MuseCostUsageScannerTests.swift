...
struct MuseCostUsageScannerTests {
    ...
    func `real Muse CLI runtime log counts model_completed once and keeps model name`() throws {
        ...
        let lines = [
            ...
            "payload":{"kind":"run","run_id":"r1","event":{"kind":"goal_usage_attribution","record":{"usage_family":\
            "provider","quantity":{"unit":"tokens","reported":true,"input_tokens":1000,"output_tokens":200,\
            "cached_tokens":100,"reasoning_tokens":5}}}}}
            """,
            """
            {"schema_version":1,"recorded_at":\(recordedAt + 10),"record_type":"event","payload_type":"runtime.session",\
            "payload":{"kind":"run","run_id":"r1","event":{"kind":"model_completed","usage":{"input_tokens":1000,\
            "output_tokens":200,"cached_tokens":100,"cache_write_tokens":0,"cache_read_tokens":100,\
            "reasoning_tokens":5},"duration_ms":10,"finish_reason":"stop","model":"muse-spark-1.2"}}}
            """,
            """
            {"schema_version":1,"recorded_at":\(recordedAt + 20),"record_type":"event","payload_type":"runtime.session",\
            "payload":{"kind":"run","run_id":"r1","event":{"kind":"goal_usage_attribution","record":{"usage_family":\
            "tool","quantity":{"unit":"tokens","reported":false,"input_tokens":0,"output_tokens":0,"cached_tokens":0}}}}}
            """,
        ]
